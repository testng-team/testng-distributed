...
/**
 * <code>OutputDirectoryPatch</code> is a helper class to provide an output
 * directory for TestNG tests that explicitly create an instance of TestNG and
 * do not know the output directory specified for the test.
 *
 * @author   cquezel
...
public final class OutputDirectoryPatch {
    /**
     * The default output directory name if none was specified. We should use
     * something different than "test-output" to make it clear that the output
    ...
    private static final String OUTPUT_DIRECTORY_PROPERTY_NAME =
        "testng.outputDir";
    ...
    public static String getOutputDirectory() {
        final String tmp = System.getProperty(OUTPUT_DIRECTORY_PROPERTY_NAME);
